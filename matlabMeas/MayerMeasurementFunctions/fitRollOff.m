function [fitresult, gof] = fitRollOff(frequencies, voltageRatio)
%  Create a fit.
...
[xData, yData] = prepareCurveData(frequencies,voltageRatio);
...
opts.Display = 'Off';
opts.StartPoint = [frequencies(1) frequencies(end) 1];
