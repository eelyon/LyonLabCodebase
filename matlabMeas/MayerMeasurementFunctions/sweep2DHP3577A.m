function [] = sweep2DHP3577A(sweepTypes, starts, stops, deltaParams, devices, ports, timeBetweenPoints,HP3577A,extraPorts)
...
for valueIndex1 = 1:length(paramVector1) %loops through 1 first
    ...
    for valueIndex2 = valueIndexVector2 %loops through 1 first
        ...
        [freqArr,datArr,voltageGain,fit] = pull3577ARollOff(HP3577A,500,20000);
        plotHandle.CData(valueIndex1, valueIndex2) = fit.b;
    end
end
