function [] = baseCurrentVsVoltage(vSource,DMM,chan,pHandle,startVoltage,stopVoltage,deltaVoltage,resistorVal,divider,waitTime)
...
for i=voltArr   
    ...
    delay(waitTime);
    voltage_Vbb(currentVal) = queryVolt(vSource,chan)/divider;
    delay(waitTime);
    current_Ib(currentVal) = queryHP34401A(DMM)/resistorVal;
