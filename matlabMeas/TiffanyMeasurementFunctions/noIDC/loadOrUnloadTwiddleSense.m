...
% let in electrons
sigDACRampVoltage(controlDAC,[STOBiasEPort,StmEPort,STIBiasEPort],[STVoltage-0.3,STVoltage-0.2,STVoltage-0.2],numSteps);
...
sweep1DMeasSR830({'TWW'},STVoltage,STVoltage-0.4,0.05,0.1,10,{SR830Twiddle},controlDAC,{TwiddleEPort},1,1);
...
sigDACRampVoltage(controlDAC,[STOBiasCPort,StmCPort,STIBiasCPort],[STCVoltage+0.7,STCVoltage+0.7,STCVoltage+0.7],numSteps);
sweep1DMeasSR830({'Door'},STCVoltage-1,STCVoltage+0.2,0.1,0.1,10,{SR830TwiddleC},controlDAC,{DoorCInPort},1,1);
sigDACRampVoltage(controlDAC,[STOBiasCPort,StmCPort,STIBiasCPort],[STCVoltage,STCVoltage,STCVoltage],numSteps);

% let in electrons
sigDACRampVoltage(controlDAC,[STOBiasCPort,StmCPort,STIBiasCPort],[STCVoltage-0.4,STCVoltage-0.3,STCVoltage-0.3],numSteps);
