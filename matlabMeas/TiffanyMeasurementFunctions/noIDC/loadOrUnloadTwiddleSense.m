...
sweep1DMeasSR830({'Door'},-1,0.1,0.2,0.1,10,{SR830TwiddleC},controlDAC,{DoorCInPort},1,1);
...
sigDACRampVoltage(controlDAC,[STOBiasCPort,StmCPort,STIBiasCPort],[0,0,0],numSteps);
sweep1DMeasSR830({'TWW'},0,-0.5,0.05,0.1,10,{SR830TwiddleC},controlDAC,{TwiddleCPort},1,1);
disp(i)
end