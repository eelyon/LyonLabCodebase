...
void setup(){
  ...
  Serial.begin(250000); // in the end we won't need serial but it is useful for debugging.
...
double getDACvoltage(int channel)
{
  ...
  GotValue = GotValue >> (20-MAX_RESOLUTION);
  GotValue = GotValue & 0x3FFFF;
  value = (double)GotValue;
  value = value*19.6/262143-9.8;
  return value;
}
...
if(firstloop){
  ...
  setDACvoltage(1, value);
  delay(10);
  setDACvoltage(2, value);
  delay(10);
  setDACvoltage(3, value);
  delay(10);
  setDACvoltage(4, value);
  delay(10);
  setDACvoltage(5, value);
  delay(10);
  setDACvoltage(6, value);
  delay(10);
  setDACvoltage(7, value);
  delay(10);
  setDACvoltage(8, value);
  delay(10);
  setDACvoltage(9, value);
  delay(10);
  setDACvoltage(10, value);
  delay(10);
  setDACvoltage(11, value);
  delay(10);
  setDACvoltage(12, value);
  delay(10);
  setDACvoltage(13, value);
  delay(10);
  setDACvoltage(14, value);
  delay(10);
  setDACvoltage(15, value);
  delay(10);
  setDACvoltage(16, value);
  delay(10);
  setDACvoltage(17, value);
  delay(10);
  setDACvoltage(18, value);
  delay(10);
  setDACvoltage(19, value);
  delay(10);
  setDACvoltage(20, value);
  delay(10);
  setDACvoltage(21, value);
  delay(10);
  setDACvoltage(22, value);
  delay(10);
  setDACvoltage(23, value);
  delay(10);
  setDACvoltage(24, value);
}
