...
%---------------------------------------------------------------------------
%
% This sample configures an ATS9625 to make a triggered streaming 
% AutoDMA acqusition, optionally saving the data to file and displaying it
% on screen.
%
% In triggered streaming mode, the digitizer waits for a trigger event,
% and then captures a continuous stream of samples from each enabled channel. 
% The data can span multiple AutoDMA buffers, where each buffer contains a 
% segment of the continuous data stream.
