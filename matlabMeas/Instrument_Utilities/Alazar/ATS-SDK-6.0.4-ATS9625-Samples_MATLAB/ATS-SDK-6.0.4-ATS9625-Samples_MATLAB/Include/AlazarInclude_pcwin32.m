...
%This function was generated by loadlibrary.m parser version 1.1.6.29 on Mon Jul 16 09:22:51 2012
...
% unsigned int AlazarStartAutoDMA ( HANDLE h , void * Buffer1 , U32 UseHeader , U32 ChannelSelect , long TransferOffset , U32 TransferLength , long RecordsPerBuffer , long RecordCount , U32 * error , U32 r1 , U32 r2 , U32 * r3 , U32 * r4 ); 
fcns.name{fcnNum}='AlazarStartAutoDMA'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'ulong', 'ulong', 'long', 'ulong', 'long', 'long', 'ulongPtr', 'ulong', 'ulong', 'ulongPtr', 'ulongPtr'};fcnNum=fcnNum+1;
% unsigned int AlazarGetNextAutoDMABuffer ( HANDLE h , void * Buffer1 , void * Buffer2 , long * WhichOne , long * RecordsTransfered , U32 * error , U32 r1 , U32 r2 , long * TriggersOccurred , U32 * r4 ); 
fcns.name{fcnNum}='AlazarGetNextAutoDMABuffer'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'voidPtr', 'longPtr', 'longPtr', 'ulongPtr', 'ulong', 'ulong', 'longPtr', 'ulongPtr'};fcnNum=fcnNum+1;
% unsigned int AlazarGetNextBuffer ( HANDLE h , void * Buffer1 , void * Buffer2 , long * WhichOne , long * RecordsTransfered , U32 * error , U32 r1 , U32 r2 , long * TriggersOccurred , U32 * r4 ); 
fcns.name{fcnNum}='AlazarGetNextBuffer'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'voidPtr', 'longPtr', 'longPtr', 'ulongPtr', 'ulong', 'ulong', 'longPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
% unsigned int AlazarAbortAutoDMA ( HANDLE h , void * Buffer , U32 * error , U32 r1 , U32 r2 , U32 * r3 , U32 * r4 ); 
fcns.name{fcnNum}='AlazarAbortAutoDMA'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'ulongPtr', 'ulong', 'ulong', 'ulongPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='AlazarAsyncRead'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'ulong', 's_OVERLAPPEDPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='AlazarCoprocessorDownloadW'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint16Ptr', 'ulong'};fcnNum=fcnNum+1;
