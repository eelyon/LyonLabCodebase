...
%This function was generated by loadlibrary.m parser version 1.1.6.29 on Fri Jul 13 16:17:29 2012
...
% fcns.thunkname{fcnNum}='uint32voidPtrulongvoidPtrThunk';fcns.name{fcnNum}='AlazarGetTriggerTimestamp'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'errorPtr'};fcnNum=fcnNum+1;
...
% fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrvoidPtrvoidPtrvoidPtrulongulongvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarGetNextAutoDMABuffer'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'voidPtr', 'longPtr', 'longPtr', 'errorPtr', 'ulong', 'ulong', 'longPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
% fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrvoidPtrvoidPtrvoidPtrulongulongvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarGetNextBuffer'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'voidPtr', 'longPtr', 'longPtr', 'errorPtr', 'ulong', 'ulong', 'longPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
% fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrulongulongvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarAbortAutoDMA'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'errorPtr', 'ulong', 'ulong', 'ulongPtr', 'ulongPtr'};fcnNum=fcnNum+1;
% U32 AlazarGetAutoDMAHeaderValue ( HANDLE h , U32 Channel , void * DataBuffer , U32 Record , U32 Parameter , AUTODMA_STATUS * error ); 
% fcns.thunkname{fcnNum}='ulongvoidPtrulongvoidPtrulongulongvoidPtrThunk';fcns.name{fcnNum}='AlazarGetAutoDMAHeaderValue'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'voidPtr', 'ulong', 'ulong', 'errorPtr'};fcnNum=fcnNum+1;
% float AlazarGetAutoDMAHeaderTimeStamp ( HANDLE h , U32 Channel , void * DataBuffer , U32 Record , AUTODMA_STATUS * error ); 
% fcns.thunkname{fcnNum}='floatvoidPtrulongvoidPtrulongvoidPtrThunk';fcns.name{fcnNum}='AlazarGetAutoDMAHeaderTimeStamp'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='single'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'voidPtr', 'ulong', 'errorPtr'};fcnNum=fcnNum+1;
% void * AlazarGetAutoDMAPtr ( HANDLE h , U32 DataOrHeader , U32 Channel , void * DataBuffer , U32 Record , AUTODMA_STATUS * error ); 
% fcns.thunkname{fcnNum}='voidPtrvoidPtrulongulongvoidPtrulongvoidPtrThunk';fcns.name{fcnNum}='AlazarGetAutoDMAPtr'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='voidPtr'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'ulong', 'voidPtr', 'ulong', 'errorPtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrulongvoidPtrThunk';fcns.name{fcnNum}='AlazarAsyncRead'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'ulong', 'voidPtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrulongThunk';fcns.name{fcnNum}='AlazarCoprocessorDownloadW'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint16Ptr', 'ulong'};fcnNum=fcnNum+1;
