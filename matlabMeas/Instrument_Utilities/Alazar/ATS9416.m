classdef ATS9416
    ...
    methods
        ...
        function [result,buffer,channelCount,bitsPerSample] = ATS9416AcquireData_NPT(ATS9416, postTriggerSamples, records, buffersPerAcquisition, channelMask)
        ...
        function [xaxis,bufferVolts] = bufferToVolts(buffer, bitsPerSample,records)
            ...
            xaxis = linspace(0, samples/ATS9416.samplesPerSec, length(bufferVolts(1,:)));
        end
        
        function [X,Y] = ATS9416GetXY(ATS9416,buffer)
