...
T = samplesPerRecord/Fs; % 1;               % Duration of the signal (seconds)
...
% signal = sqrt(2)*cos(2*pi*f_signal*t) + noise_level*randn(size(t)); % Signal with noise
...
hold on
plot(t(1:100), real(reference_signal(1:100)/sqrt(2)));
hold off
