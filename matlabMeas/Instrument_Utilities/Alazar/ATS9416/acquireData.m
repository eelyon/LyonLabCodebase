...
%---------------------------------------------------------------------------
%
% Copyright (c) 2008-2012 AlazarTech, Inc.boar
%
...
preTriggerSamples = uint32(4096);

%TODO: Select the number of post-trigger samples per record 
postTriggerSamples = uint32(4096);

% TODO: Select the number of records in the acquisition
recordsPerCapture = uint32(100);
...
% TODO: Select which channels read from on-board memory (A, B, C,... or multiple)
