...
% NPT parameters
postTriggerSamples = 256000; % Has to be at least 256 and multiple of 128
...
phase = 60*pi/180; %-40*pi/180; %70*pi/180; %60*pi/180;
[X,Y] = ATS9416GetXY(bufferVolts, samplesPerSec, samplesPerBufferPerChannel, f_signal, 'square',phase);
Xrms = sqrt(mean(X.^2))
Yrms = sqrt(mean(Y.^2))
