function [] = configAWG_mem(AWG, CHAN, YNORM, SRATE, VLOW, VHIGH, NBURST, TRIGSRC)
% configAWG  Configure a Keysight 33512B channel with an arbitrary waveform.
%
...
%   NBURST - burst cycle count (integer >= 1)
    ...
    y_dac = int16((YNORM*2 - 1) * 32767);
    writebinblock(AWG.client, y_dac, "int16", "SOUR" + num2str(CHAN) + ":DATA:ARB:DAC SHUTTLE"+num2str(CHAN)+", ");
    pause(1 + N * 2 / 5e6);
