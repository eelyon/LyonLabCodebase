...
macro InitDAC()
	...
	variable/G NumChan=24				//# of available chanels 	(4 (or 8 if two boards present))
	variable/G ingot=1 					//ingot = 1 : ingot present and the used D/A board
	string/G DAC_COMPORT
...
//	VDTOperationsPort COM3   //Use COM3 for PXI bus
	...
	//recalibrated on BF#2 using SiGe filters Aug 19, 2013 CMP
	
	DACRange[0] =  9945.61//9939				 //these numbers here have to be determined experimentally
	DACOffset[0] = -1.1//-2.90402 //-2.4           			 //hooking up a DMM (runing in, say, fast 6 digits mode)
	  							 //and runing the CalDac(chan)/initdac routines a few times until
	DACRange[1] =  9948.54//9944
	DACOffset[1] =  -1.2//-1.18065//-1.86	
	DACRange[2] = 9963.89//9927
	DACOffset[2] = -1.3//-1.2664//-1.88
	DACRange[3] = 9965.94//9925.7
	DACOffset[3] = 0.3//-1.4764//-2.09  
	DACRange[4] = 9968.48//9931
	DACOffset[4] =-0.4// -1.16501//-1.68
	DACRange[5] = 9945.77//9929
	DACOffset[5] =2.4//-2.80769//- 2.1
	DACRange[6] = 9962.8//9948
	DACOffset[6] =-1.6// -2.80769//-3.75
	DACRange[7] = 9962.39//9947
	DACOffset[7] = 0.8//-1.9862//-3.06
	DACRange[8] = 9949.5// 9942
	DACOffset[8] = 0.2//-0.800753//-1.25
	DACRange[9] = 9957.98//9942
	DACOffset[9] =-2.7// -1.22204//-2
	
	
	DACRange[10] =9960.94//9942.2
	DACOffset[10] =-0.8// -8.84145//-11
	DACRange[11] = 9952.05//9941
	DACOffset[11] = -2.0// -2.68778//-3.4
	DACRange[12] = 9955.35//9923
	DACOffset[12] =-0.6// -4.05759//-5.23
	DACRange[13] = 9947.12//9919.5
	DACOffset[13] = -1.3//-3.46046//-4.6
	DACRange[14] = 9973.3//9923
	DACOffset[14] = -1.2//-1.22065//-1.9
	DACRange[15] = 9976.18//9946
	DACOffset[15] =-1.4// -3.7262//-4.8  

variable/G  DividerDAC 
	variable divider= DividerDAC
	DACDivider[0] = divider						//if you use a Voltage divider on output of DAC
	DACDivider[1] = divider					//put the amount it divides by here and you won't
	DACDivider[2] = divider						//ever have to convert any Voltages in your head
	DACDivider[3] = divider
	...
	DACDivider[12] = divider						//never have to convert any Voltages in your head
	DACDivider[13] = divider
...
//	setDAC(0,0)							//set all chanels to zero
//	setDAC(1,0)
//	setDAC(2,0)
//	setDAC(3,0)
//	setDAC(4,0)
...
Function Conv20BitJP(bin)	//To decompose a 20bit number into 7bit, 8bit, 8bit
	Variable bin		//bin is the bin or subdivision number that the channel is supposed to be set to
							// (bin not equal to binary!! all numbers are decimal)
	variable/G by1
	variable/G by2
	variable/G by3
...
Window DACstatus() : Table
	...
	Edit/W=(694.5,65.75,851.25,361.25) DACLabel,DAC,DACDivider,DACLimit,DACOffset,DACRange
	ModifyTable format(Point)=1,width(Point)=26,title(Point)="Chan",width(DACLabel)=57
	ModifyTable title(DACLabel)="DAC Label",width(DAC)=60,width(DACDivider)=57,title(DACDivider)="DAC Divider"
	ModifyTable width(DACLimit)=53,title(DACLimit)="DAC Limit",title(DACOffset)="DAC Offset"
	ModifyTable title(DACRange)="DAC Range"
EndMacro