function sample = MFLIGetSample(device_id, varargin)
% MFLIGETSAMPLE Connect to and configure a Zurich Instruments device
%
% USAGE R = MFLIGETSAMPLE(DEVICE_ID)
%
...
% functionality should almost always be used instead of `getSample`.
