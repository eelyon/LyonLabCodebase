...
for i = 1:totalPulseNum
    currentCenter = targetCenterInSamples + centerSpacingInSamples*(i-1)+.25*(i-1);
...
plotData(piPulseNum,minLoc,'xlabel',"\pi pulse number",'ylabel',"Location of minimum I");
