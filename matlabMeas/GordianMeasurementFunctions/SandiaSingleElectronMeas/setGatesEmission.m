...
%% Set Sommer-Tanner
sigDACRamp(pinout.tm.device,pinout.tm.port,vlow,numStepsRC,waitTimeRC) % ramp top metal
...
sigDACRamp(pinout.d5.device,pinout.d5.port,vlow,numStepsRC,waitTimeRC); % compensation
...
sigDACRampVoltage(pinout.twiddle1.device,pinout.twiddle1.port,vlow,numSteps)
...
sigDACRampVoltage(pinout.twiddle2.device,pinout.twiddle2.port,vlow,numSteps)
