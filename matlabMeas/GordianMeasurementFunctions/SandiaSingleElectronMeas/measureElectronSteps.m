...
[nE,nErr] = measureElectronsFn(pinout,1,'vstart',0,'vstop',-0.7,'vstep',-0.02,'filter_order',2, ...
    'time_constant',0.5,'demod_rate',1e3,'poll',10,'sweep',0,'onoff',1);
...
%     return
    ...
    unloadSense1(pinout,'vopen',4,'vclose',-1); delay(2)
