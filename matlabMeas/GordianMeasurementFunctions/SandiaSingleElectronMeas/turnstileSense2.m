...
for vturn = 0.45
    ...
    sigDACRamp(pinout.d7.device,pinout.d7.port,vhigh-vturn,numStepsRC,waitTimeRC); delay(1)
    sigDACRampVoltage(pinout.d4.device,pinout.d4.port,vhigh+vturn,numSteps)
    ...
    % Move electrons on d4 to Sense1
