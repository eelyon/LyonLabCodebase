function genCCDPulses_fast(awg1, awg2, awg3, varargin)
...
STEP_S2F    = max(T_s2f, v3_zero_rel) - T_f + THIRD_f;
...
function add_fast_399px()
    add(5, T_s2f, STEP_S2F, 's2f'); % HALF_s - SIXTH_f
    add(6, T_f, THIRD_f, 'f');
    for pix = 1:398
        add(4, T_f, THIRD_f, 'f');
        add(5, T_f, THIRD_f, 'f');
