...
figure()
[p1,x1,mag1] = plot_electrons(figPath1,1,2,cap,gain);
[p2,x2,mag2] = plot_electrons(figPath2,1,2,cap,gain);
[p3,x3,mag3] = plot_electrons(figPath3,1,2,cap,gain);
[p4,x4,mag4] = plot_electrons(figPath4,1,2,cap,gain);
[p5,x5,mag5] = plot_electrons(figPath5,1,2,cap,gain);
[p6,x6,mag6] = plot_electrons(figPath6,1,2,cap,gain);
...
m = [x1.', mag1.', mag2.', mag3.', mag4.', mag5.', mag6.'];
T = table(x1.', mag1.', mag2.', mag3.', mag4.', mag5.', mag6.', ...
    'VariableNames',{'xvals','mag_21778','mag_21776','mag_21774','mag_21772','mag_21770','mag_21768'});
writetable(T, [path,'11_05_25\','electronSteps.csv'],'QuoteStrings', true);

% xlim([-1.05,0.25])
% ylim([-0.7,16])

function [plotHandle,xvals,mag] = plot_electrons(figPath,ax1,ax2,cap,gain)
