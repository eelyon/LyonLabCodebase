...
sigDACRampVoltage(twiddle.Device,twiddle.Port,-1.5,500); % make twiddle negative
...
[avgMag,avgReal,avgImag,stdReal,stdImag] = sweep1DMeasSR830({'Shield'},startShield,stopShield,0.02,1,numRepeats,{SR830Twiddle},shieldl.Device,{shieldl.Port},0,1); % sweep shield
