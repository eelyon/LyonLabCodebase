...
interleavedRamp(sense1_l.Device,sense1_l.Port,0.2,numStepsRC,waitTime) % rampSIM900Voltage(sense1_l.Device,sense1_l.Port,0,waitTime,delta)
...
interleavedRamp(d5.Device,d5.Port,0.4,numStepsRC,waitTime)
interleavedRamp(sense1_l.Device,sense1_l.Port,Vclose,numStepsRC,waitTime) % rampSIM900Voltage(sense1_l.Device,sense1_l.Port,-0.5,waitTime,delta)
sigDACRampVoltage(d4.Device,d4.Port,0.8,numSteps)
interleavedRamp(d5.Device,d5.Port,Vclose,numStepsRC,waitTime)
sigDACRampVoltage(phi1_1.Device,phi1_1.Port,1.2,numSteps)
sigDACRampVoltage(d4.Device,d4.Port,Vclose,numSteps) % Set d4 s.t. electrons can't get onto top metal in parallel channels
...
interleavedRamp(d5.Device,d5.Port,Vclose,numStepsRC,waitTime)
interleavedRamp(guard1_l.Device,guard1_l.Port,0.2,numStepsRC,waitTime)
sigDACRampVoltage(sense1_r.Device,twiddle1.Port,0.2,numSteps)
sigDACRampVoltage(guard1_r.Device,guard1_r.Port,0.2,numSteps)
interleavedRamp(sense1_l.Device,sense1_l.Port,Vclose,numStepsRC,waitTime) % rampSIM900Voltage(sense1_l.Device,sense1_l.Port,-0.5,waitTime,delta)
