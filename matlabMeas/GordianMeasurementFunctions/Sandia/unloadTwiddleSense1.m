...
sigDACRamp(sense1_l.Device,sense1_l.Port,0.2,numStepsRC,waitTimeRC) % rampSIM900Voltage(sense1_l.Device,sense1_l.Port,0,waitTimeRC,delta)
...
sigDACRamp(d5.Device,d5.Port,0.4,numStepsRC,waitTimeRC)
sigDACRamp(sense1_l.Device,sense1_l.Port,Vclose,numStepsRC,waitTimeRC) % rampSIM900Voltage(sense1_l.Device,sense1_l.Port,-0.5,waitTimeRC,delta)
