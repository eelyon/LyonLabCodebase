...
interleavedRamp(sense1_l.Device,sense1_l.Port,0,numStepsRC,waitTime) % rampSIM900Voltage(sense1_l.Device,sense1_l.Port,0,waitTime,delta)
interleavedRamp(guard1_l.Device,guard1_l.Port,0,numStepsRC,waitTime)
interleavedRamp(twiddle1.Device,twiddle1.Port,0,numStepsRC,waitTime)
...
interleavedRamp(twiddle1.Device,twiddle1.Port,0,numStepsRC,waitTime) % set twiddle to 0V
sigDACRampVoltage(guard1_r.Device,guard1_r.Port,-2,numSteps) % set right shield to -2V
interleavedRamp(sense1_l.Device,sense1_l.Port,0,numStepsRC,waitTime)
TwiddleUnload_Full;