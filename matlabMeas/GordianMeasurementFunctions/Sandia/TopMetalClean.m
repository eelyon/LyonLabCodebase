...
interleavedRamp(TM.Device,TM.Port,-0.7,numStepsRC,waitTime); % make top metal less negative
% sigDACRampVoltage(phi1_1.Device,phi1_1.Port,Vclean,numSteps)

%% Loop top metal sweep and unload electrons
for n = 1:2
    sweep1DMeasSR830({'TM'},-0.7,-2.1,0.2,3,1,{SR830Twiddle},TM.Device,{TM.Port},1,1);
    TwiddleUnload_Full;
end
