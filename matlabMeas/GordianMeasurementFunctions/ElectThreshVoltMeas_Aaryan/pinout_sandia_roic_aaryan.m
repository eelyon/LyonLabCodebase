...
pinout.phi_h1_1.port = 14; % phi 1

pinout.phi_h1_2.device = controlDAC;
pinout.phi_h1_2.port = 12; % phi 2

pinout.phi_h1_3.device = controlDAC;
pinout.phi_h1_3.port = 13; % phi 3
...
pinout.d7.port = 10; % compensation door for 2nd twiddle-sense
pinout.sense2_l.device = controlDAC;
pinout.sense2_l.port = 24;
